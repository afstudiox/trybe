...
// 3. Crie uma classe CharacterService que recebe como dependência em seu construtor uma 
// instância do tipo LocalDbModel e a utilize em sua lógica de negócio.
...
class CharacterService {
  ...
  async update(id: number, character: Character) {
    const upadatedCharacter = await this.model.update(id, character);
    return ({ status: 204 })
  }
